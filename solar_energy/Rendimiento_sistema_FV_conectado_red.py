...
def modelo_fotovoltaico(latitud, longitud, nombre, placas, cadenas):
    ...
    system = PVSystem(surface_tilt=30, surface_azimuth=180,
                    ...
                    temperature_model_parameters=temperature_parameters, modules_per_string=placas, strings_per_inverter=cadenas)

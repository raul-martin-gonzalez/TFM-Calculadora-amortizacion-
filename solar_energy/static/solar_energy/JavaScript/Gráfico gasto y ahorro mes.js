contenedor_grafica = document.getElementById('chart_gasto_ahorro_mes');
...
function gasto_ahorro_mes(container, props) {
...
function render_gasto_ahorro_mes(){
    gasto_ahorro_mes(d3.select("#chart_gasto_ahorro_mes"), {
...
window.addEventListener('resize', render_gasto_ahorro_mes);